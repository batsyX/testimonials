...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "h-screen max-sm:h-[600px] md:h-[40rem] bg-gradient-to-b  dark:from-neutral-950 dark:to-neutral-800 relative flex flex-col items-center w-full  overflow-hidden",
